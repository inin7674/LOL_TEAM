...
const CHANGELOG_ENTRIES_NORMAL = [
  {
    date: '2026-02-26',
    items: [
      '닉네임 옆 복사 아이콘을 추가해 원하는 닉네임을 바로 복사할 수 있어요.',
      '대기/팀/팝업 영역의 닉네임 표시 스타일을 통일해 화면이 더 보기 편해졌어요.',
      '화면 구성을 정리해 명단 확인이 더 깔끔하고 직관적으로 바뀌었어요.',
    ],
  },
  {
    date: '2026-02-08',
...
const CHANGELOG_ENTRIES_AUCTION = [
  {
    date: '2026-02-26',
    items: [
      '닉네임 옆 복사 아이콘을 추가해 경매 명단과 팀 명단에서 바로 닉네임을 복사할 수 있어요.',
      '경매 화면 요소를 정리해 버튼과 명단 확인이 더 직관적으로 보이도록 개선했어요.',
      '모달 동작을 다듬어 화면 전환이 더 자연스럽고 안정적으로 느껴져요.',
    ],
  },
  {
    date: '2026-02-14',
  ...
  },
  {
    date: '2026-02-13',
    items: [
      '방만들기/방참가 과정에서 발생하던 진입 실패를 줄이도록 안정성을 개선했어요.',
      '방 생성/참가 후 화면 상태가 더 빠르고 자연스럽게 동기화되도록 정리했어요.',
